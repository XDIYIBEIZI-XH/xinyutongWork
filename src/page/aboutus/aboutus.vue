                      ...
                      <div class="span6 col-xm-12">
                        <div class="introduce_list">
                          <div class="introduce_list_brief">
                            <div class="introduce_list_title">xxxx</div>
                            <div class="introduce_list_text">拥有10年互联网行业的专研和沉淀</div>
                          </div>
                          <div class="introduce_list_brief">
                            <div class="introduce_list_title">xxxx</div>
                            <div
                              class="introduce_list_text"
                            >积累了雄厚的自主研发实力和丰富的互联网整合营销案例，为企业打造更完善的企业互联网解决方案</div>
                          </div>
                          <div class="introduce_list_brief">
                            <div class="introduce_list_title">xxxx</div>
                            <div
                              class="introduce_list_text"
                            >以DEDECMS架构为基础，开发业内领先的智能响应式技术和网站建设方案为企业提供多元、高效、快速的网站建设方案</div>
                          </div>
                          <div class="introduce_list_brief">
                            <div class="introduce_list_title">xxxx</div>
                            <div
                              class="introduce_list_text"
                            >倾力打互联网行业建站主力军，让企业告别高额的网站制作费，为企业成本价快速制作企业官方网站，打造企业互联网品牌</div>
                          </div>
                          <div class="introduce_list_brief">
                            <div class="introduce_list_title">xxxx</div>
                            <div
                              class="introduce_list_text"
                            >整合优质企业服务商，为企业建设开放式的企业"互联网+"商业生态圈，满足企业各个阶段不同需求，提升品牌价值，同时降低运营成本</div>
                          </div>
                        </div>
                      </div>
                      <div class="span6 col-xm-12">
                  ...
                  <div class="advantage_project_content">
                      ...
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[0]" alt="免费响应式建站平台">
                          </div>
                        </div>
                        <div class="span9">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[1]" alt="免费响应式建站平台.PNG">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[2]" alt="免费响应式自助建站">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[3]" alt="免费响应式自助建站.PNG">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[4]" alt="响应式建站平台代理">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[5]" alt="响应式建站平台代理">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[6]" alt="响应式建站平台代理.PNG">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[7]" alt="响应式建站平台加盟">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                  ...
                  <div class="advantage_project_content">
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[8]" alt="金猪云建站平台">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[9]" alt="全网整合营销代理">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[10]" alt="互联网资深研发团队">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
                    ...
                    <div class="span3 col-xm-6 col-xs-12">
                      <div class="advantage_project_list">
                        <div class="span3">
                          <div class="advantage_project_list_img">
                            <img :src="advanceList[11]" alt="响应式网站建设优质企业服务商">
                          </div>
                        </div>
                        <div class="span9">
                          <div class="advantage_project_list_brief">
...
export default {
  data() {
    return {
        ...
        advanceList: [
            require('../../assets/images/081.png'),
            require('../../assets/images/082.png'),
            require('../../assets/images/083.png'),
            require('../../assets/images/084.png'),
            require('../../assets/images/085.png'),
            require('../../assets/images/086.png'),
            require('../../assets/images/087.png'),
            require('../../assets/images/088.png'),
            require('../../assets/images/089.png'),
            require('../../assets/images/090.png'),
            require('../../assets/images/091.png'),
            require('../../assets/images/092.png'),
        ]
    }
  }
};
