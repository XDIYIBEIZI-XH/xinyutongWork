            ...
            <div class="container">
                ...
                <div class="platform_advantage_content">
                    ...
                    <div class="platform_advantage_list">
                        <div class="platform_advantage_img"> <img :src="picData.advanceList[0]" alt="响应式建站平台" /> </div>
                    ...
                    <div class="platform_advantage_list">
                        <div class="platform_advantage_img"> <img :src="picData.advanceList[1]" alt="响应式网站建设" /> </div>
                        <div class="platform_advantage_brief">
                    ...
                    <div class="platform_advantage_list">
                        <div class="platform_advantage_img"> <img :src="picData.advanceList[2]" alt="响应式自助建站" /> </div>
                        <div class="platform_advantage_brief">
                    ...
                    <div class="span4 col-xm-6 col-xs-12 wow bounceInLeft">
                    <div class="platform_advantage_list">
                        <div class="platform_advantage_img"> <img :src="picData.advanceList[3]" alt="响应式网站定制" /> </div>
                        <div class="platform_advantage_brief">
                    ...
                    <div class="span4 col-xm-6 col-xs-12 wow bounceIn">
                    <div class="platform_advantage_list">
                        <div class="platform_advantage_img"> <img :src="picData.advanceList[4]" alt="html5建站平台" /> </div>
                        <div class="platform_advantage_brief">
                    ...
                    <div class="span4 col-xm-6 col-xs-12 wow bounceInRight">
                    <div class="platform_advantage_list">
                        <div class="platform_advantage_img"> <img :src="picData.advanceList[5]" alt="H5响应式网站建设" /> </div>
                        <div class="platform_advantage_brief">
                ...
                <div class="response_shows">
                    <div class="response_shows_box wow bounceIn">
                        <div class="response_shows_width">
                            <div class="pc"> <img :src="picData.showList[0]" alt="建站神器" />
                            <div class="pic">
                                <div class="item"> <img :src="picData.detailList[0]" alt="快速响应式网站制作" /> </div>
                                <div class="item"> <img :src="picData.detailList[1]" alt="网站建设" /> </div>
                                <div class="item"> <img :src="picData.detailList[2]" alt="响应式自助建站" /> </div>
                            </div>
                            </div>
                            <div class="pad"> <img :src="picData.showList[2]" alt="H5响应式网站建设" />
                            <div class="pic">
                                <div class="item"> <img :src="picData.detailList[3]" alt="建站" /> </div>
                                <div class="item"> <img :src="picData.detailList[4]" alt="生态级响应式2.0建站平台" /> </div>
                                <div class="item"> <img :src="picData.detailList[5]" alt="H5响应式网站建设" /> </div>
                            </div>
                            </div>
                            <div class="phone"> <img :src="picData.showList[1]" alt="响应式网站模板" />
                            <div class="pic">
                                <div class="item"> <img :src="picData.detailList[6]" alt="响应式网站设计案例" /> </div>
                                <div class="item"> <img :src="picData.detailList[7]" alt="响应式网站案例" /> </div>
                                <div class="item"> <img :src="picData.detailList[8]" alt="html5建站平台" /> </div>
                            </div>
                            </div>
                            <div class="thumb">
                            </div>
